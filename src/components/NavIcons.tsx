...
const NavIcons = () => {
    ...
    return (
        <div className=' flex gap-4 items-center xl:gap-6 relative '>
            ...
            <Image src="/notification.png" alt="user" width={22} height={22} className='cursor-pointer' />
            <div className=" relative cursor-pointer ">
                <Image src="/cart.png" alt="user" width={22} height={22} onClick={() => setisCartOpen((prev) => !prev)} />
